 ...
 */
public class NewsCursorRecyclerAdapter extends CursorRecyclerAdapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private LayoutInflater mInflater;

    public NewsCursorRecyclerAdapter(Context context, Cursor c) {
        super(c);
        mContext = context;
        ...
        public EventCursorRecyclerViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v) {
                    ...
                    Intent detailIntent = new Intent(v.getContext(),NewsDetailActivity.class);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, Cursor cursor) {
        ...
        ((EventCursorRecyclerViewHolder)holder).id = mCursor.getLong(NewsFragment.COL_NEWS_ID);
        ((EventCursorRecyclerViewHolder)holder).textView.setText(mCursor.getString(NewsFragment.COL_NEWS_TITLE));

        int width = 200, height = 200;
        ImageRequest request = ImageRequestBuilder.newBuilderWithSource(Uri.parse(mCursor.getString(NewsFragment.COL_NEWS_IMAGEURL)))
